...
return [
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                'createStudent' => \App\GraphQL\Mutations\Student\CreateStudentMutation::class,
                'updateStudent' => \App\GraphQL\Mutations\Student\UpdateStudentMutation::class,
                'deleteStudent' => \App\GraphQL\Mutations\Student\DeleteStudentMutation::class,
            ],
